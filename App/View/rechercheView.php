...
use App\Controller\{Produits, Utilisateurs};
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><?= $produit['presentation'] ?></p>
                                    <p class="card-text"><?= $produit['quantite'] ?></p>
                                    <p class="card-text"><?= $produit['prix'] ?> €</p>
                                    <a href="?id_produit=<?= $produit['id_produit'] ?>" class="btn btn-primary">Ajouter au panier</a>
                                </div>
                            </div>
                        </div>
                    <?php
