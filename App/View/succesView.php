...
if(isset($_GET['session_id']) && isset($_SESSION['panier']) && isset($_SESSION['profil'])){
...
<body>
    ...
    <main>
        ...
        <p>Commandé par : <i><?= $_SESSION['profil']['login'] ?></i></p>
    ...
    <tr>
        <td>
            <p>Article : <b><?= $produit["nom"] ?></b></p>
                            ...
                            <td>
                                <p><i><?= $produit["categ"] ?></i></p>
                            </td>
                            <td>
                                <p><i><?= $produit["sous_categ"] ?></i></p>
                            </td>
                            <td>
